...
def train_detector(model,
    ...
    if validate:
        ...
        runner.register_hook(
            eval_hook(val_dataloader, bbox_head=cfg.model.bbox_head, **eval_cfg), priority='LOW')
        # runner.register_hook(
        #     eval_hook(val_dataloader, bbox_head=cfg.model.roi_head.bbox_head, **eval_cfg), priority='LOW')
    resume_from = None
