...
class EvalHook(BaseEvalHook):
    ...
    def __init__(self, *args, dynamic_intervals=None, bbox_head=None, **kwargs):
    ...
    def _do_evaluate(self, runner):
        ...
        results = single_gpu_test(runner.model, self.dataloader, bbox_head=self.bbox_head ,show=False)
        # results = single_gpu_test(model, data_loader, cfg.model.bbox_head, args.show,
