...
log_level = 'INFO'
load_from =None#'/media/zf/E/checkpoint/tood_r50_fpn_mstrain_2x_coco_20211210_144231-3b23174c.pth'
resume_from = '/media/zf/E/FourMask/work_dirs/fourmask6_r50_fpn_DCN_1x_isaid_crossiou+giou05_rotatetest/latest.pth'
...
evaluation = dict(interval=6, classwise=True,metric=['bbox','segm'])
